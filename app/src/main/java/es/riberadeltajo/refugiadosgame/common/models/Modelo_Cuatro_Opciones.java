...
public class Modelo_Cuatro_Opciones extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opc4.setImageResource(R.drawable.madrid_dibujo_coche); //Imagen para la opción 4
    ...
    public void goNext(){
        if(cont==OPCION_A){
            ...
            //Activity siguiente si se cumple opcion D
        }
        else{
