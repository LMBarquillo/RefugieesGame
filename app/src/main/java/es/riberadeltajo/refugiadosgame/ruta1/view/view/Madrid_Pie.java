...
public class Madrid_Pie extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerStatus.getInstancia(this).setTramo(12);
        ...
        texto.setText(R.string.madrid_pie);
    ...
    public void goNext(){
        if(cont==OPCION_A){
            ...
            startActivity(new Intent(this, Madrid_Pie_2.class));
            finish();
        }
        else{
