...
public class Madrid_Pie_2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerStatus.getInstancia(this).setTramo(16);
        ...
        texto.setText(R.string.madrid_pie2);
        ...
        opc1.setImageResource(R.drawable.madrid_ayuda); //Imagen para la opción 1
    ...
    public void goNext(){
        startActivity(new Intent(this, Madrid_Passport.class));
        finish();
    }
}
