...
public class Madrid_Wait extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerStatus.getInstancia(this).setTramo(17);
        ...
        texto.setText(R.string.madrid_wait);
