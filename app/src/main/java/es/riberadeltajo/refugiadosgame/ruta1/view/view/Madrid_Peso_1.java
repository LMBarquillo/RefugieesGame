...
public class Madrid_Peso_1 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(R.string.madrid_peso1);
    ...
    public void goNext(){
        startActivity(new Intent(this, Madrid_Peso_2.class));
        finish();
    }
}
