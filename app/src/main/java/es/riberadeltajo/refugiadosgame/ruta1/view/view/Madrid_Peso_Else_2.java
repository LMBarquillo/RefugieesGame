...
public class Madrid_Peso_Else_2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(R.string.madrid_peso_else2);
        ...
        opc1.setImageResource(R.drawable.madrid_mantas); //Imagen para la opción 1
