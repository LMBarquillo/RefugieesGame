...
public class Madrid_Rueda_1 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(R.string.madrid_rueda1);
        ...
        opc1.setImageResource(R.drawable.madrid_ruedapinchada); //Imagen para la opción 1
    ...
    public void goNext(){
        startActivity(new Intent(this, Madrid_Rueda_2.class));
        finish();
    }
}
