...
public class SarajevoBanda extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(R.string.sarajevo_txt_banda);
        linearOpciones = (LinearLayout) findViewById(R.id.lnOpciones);
        linearOpciones.setBackgroundResource(R.drawable.sarajevobanda);
        ...
        descOpc1.setText(R.string.sarajevo_txt_huir);
        descOpc2.setText(R.string.sarajevo_txt_policia);
        opc1.setImageResource(R.drawable.sarajevohuir); //Imagen para la opción 1
        opc2.setImageResource(R.drawable.sarajevopolicia); //Imagen para la opción 2
    ...
    public void opcion1(){
        ...
        msgtoast.setText(R.string.sarajevo_toast_huir);
    ...
    public void opcion2(){
        ...
        TextView msgtoast = (TextView) toast_layout.findViewById(R.id.txtMsgToast);
        msgtoast.setTypeface(font);
        msgtoast.setText(R.string.sarajevo_toast_policia);
        toast.setGravity(Gravity.CENTER,toast_layout.getWidth()/2,toast_layout.getHeight()/2);
        toast.setDuration(Toast.LENGTH_LONG);
        toast.show();
    }
