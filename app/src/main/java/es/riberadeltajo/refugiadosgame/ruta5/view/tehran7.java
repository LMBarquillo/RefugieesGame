...
public class tehran7 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(getString(R.string.tehran_text_4_4));
        ...
        opc1.setImageResource(R.drawable.tehranpreg3_0); //Imagen para la opción 1
        opc2.setImageResource(R.drawable.tehranpreg3); //Imagen para la opción 2
