...
public class Istanbul_Tehran_TicketStealed extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Texto principal
        texto.setText(R.string.istanbul_route_wannasellit);
    ...
    public void goNext() {
        if (cont == OPCION_A) {
            ...
            startActivity(new Intent(this, Istanbul_Tehran_Policeman.class));
            finish();
        } else {
