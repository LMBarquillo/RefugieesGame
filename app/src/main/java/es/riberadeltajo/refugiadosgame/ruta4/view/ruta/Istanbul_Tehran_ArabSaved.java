...
public class Istanbul_Tehran_ArabSaved extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Texto principal
        texto.setText(R.string.istanbul_route_arabfriend);
    ...
    public void goNext() {
        if (cont == OPCION_A) {
            startActivity(new Intent(this, Istanbul_Tehran_YouMadeIt.class));
            finish();
        } else if (cont == OPCION_B) {
            startActivity(new Intent(this, Istanbul_Tehran_GotLost.class));
            finish();
        }
    }
}
