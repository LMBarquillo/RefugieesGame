...
public class Istanbul_Tehran_NoWayOut extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(R.string.istanbul_route_nowayout);
        ...
        opc1.setImageResource(R.drawable.istanbulbarcochungo); //Imagen para la opción 1
